...
ページを好みに合わせてカスタマイズしてみてください。[GIFの参考サイト](https://giphy.com/)です。

![](/public/images/14-Polygon-ENS/section-2/2_2_1.png)
...
`Connect Wallet` ボタンはまだ機能せず、コンソールに`No authorized account found`と表示されます。 これは、MetaMaskに明示的に通知していないためです。*「MetaMaskさん、このウェブサイトにウォレットへのアクセスを許可してください」と伝える必要があります。*
  ...
  return (
    <div className="App">
      <div className="container">
        ...
        {/* currentAccount が存在しない場合、Connect Wallet ボタンを隠します*/}
